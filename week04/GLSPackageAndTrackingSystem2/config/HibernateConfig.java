package GLSPackageAndTrackingSystem2.config;
...
public class HibernateConfig {
    ...
    private static EntityManagerFactory buildEntityFactoryConfig() {
        try {
            ...
            props.put("hibernate.connection.url", "jdbc:postgresql://localhost:5432/glspackage?currentSchema=public");
    ...
    private static void getAnnotationConfiguration(Configuration configuration) {
        ...
        configuration.addAnnotatedClass(Package2.class);
